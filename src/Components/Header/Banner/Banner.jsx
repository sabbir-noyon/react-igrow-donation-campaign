	...
	return (
		...
		>
			<div className="absolute inset-0 bg-white bg-opacity-80 flex flex-col justify-center items-center px-4">
				<h1 className="font-serif text-center text-3xl md:text-4xl lg:text-5xl text-[#0B0B0B] font-bold mb-6 md:mb-10 lg:mb-14 leading-tight">
				...
				<div className="flex items-center w-full max-w-[90%] sm:max-w-md gap-0 overflow-hidden">
					...
					<button
						...
						className="px-4 lg:px-6 py-2 lg:py-3 bg-[#FF444A] hover:bg-[#e03c42] transition-colors duration-200 text-white rounded-r-md text-sm sm:text-base cursor-pointer"
					>
						Search
					</button>
				</div>
